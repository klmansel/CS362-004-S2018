...
int feastCard(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
  ...
  //bug created: changed coin to 4 from 5 so user will not be able to buy items over 4 coins-code compiles
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurerCard(card, choice1, choice2, choice3, state, handPos, bonus);
    case council_room:
      //+4 Cards
      for (i = 0; i < 4; i++)
	{
    ...
    case feast:
      feastCard(card, choice1, choice2, choice3, state, handPos, bonus);
    case remodel:
    ...
    case smithy:
      smithyCard(card, choice1, choice2, choice3, state, handPos, bonus);
    ...
    case ambassador:
      ambassadorCard(card, choice1, choice2, choice3, state, handPos, bonus);
    ...
    case salvager:
      salvagerCard(card, choice1, choice2, choice3, state, handPos, bonus);
    case treasure_map:
